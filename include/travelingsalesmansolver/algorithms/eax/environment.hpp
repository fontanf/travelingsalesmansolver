...
public:
	...
	void define(); // global initialization (reads the instance from fFileNameTSP)
	void defineFromEvaluator(); // global initialization (assumes fEvaluator's instance is already set)
