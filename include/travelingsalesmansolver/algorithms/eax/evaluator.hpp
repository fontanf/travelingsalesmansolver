...
public:
	...
	void setInstance(int n, const vector<vector<int>>& edgeDis); // sets variables from an in-memory distance matrix
...
private:
	void computeNearCity(); // computes fNearCity from fEdgeDis
};
